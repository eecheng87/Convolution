...
proc create_root_design { parentCell } {
  ...
  set convolution_0 [ create_bd_cell -type ip -vlnv user.org:user:convolution:1.0 convolution_0 ]
  ...
  connect_bd_net -net axi_gpio_0_gpio2_io_o [get_bd_pins axi_gpio_0/gpio2_io_o] [get_bd_pins convolution_0/start]
  connect_bd_net -net blk_mem_gen_0_doutb [get_bd_pins blk_mem_gen_0/doutb] [get_bd_pins convolution_0/M0_R_data]
  connect_bd_net -net blk_mem_gen_1_doutb [get_bd_pins blk_mem_gen_1/doutb] [get_bd_pins convolution_0/M1_R_data]
  connect_bd_net -net convolution_0_M0_R_req [get_bd_pins blk_mem_gen_0/enb] [get_bd_pins convolution_0/M0_R_req]
  connect_bd_net -net convolution_0_M0_W_data [get_bd_pins blk_mem_gen_0/dinb] [get_bd_pins convolution_0/M0_W_data]
  connect_bd_net -net convolution_0_M0_W_req [get_bd_pins blk_mem_gen_0/web] [get_bd_pins convolution_0/M0_W_req]
  connect_bd_net -net convolution_0_M0_addr [get_bd_pins blk_mem_gen_0/addrb] [get_bd_pins convolution_0/M0_addr]
  connect_bd_net -net convolution_0_M1_R_req [get_bd_pins blk_mem_gen_1/enb] [get_bd_pins convolution_0/M1_R_req]
  connect_bd_net -net convolution_0_M1_W_data [get_bd_pins blk_mem_gen_1/dinb] [get_bd_pins convolution_0/M1_W_data]
  connect_bd_net -net convolution_0_M1_W_req [get_bd_pins blk_mem_gen_1/web] [get_bd_pins convolution_0/M1_W_req]
  connect_bd_net -net convolution_0_M1_addr [get_bd_pins blk_mem_gen_1/addrb] [get_bd_pins convolution_0/M1_addr]
  connect_bd_net -net convolution_0_finish [get_bd_pins axi_gpio_0/gpio_io_i] [get_bd_pins convolution_0/finish]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_bram_ctrl_1/s_axi_aclk] [get_bd_pins axi_cdma_0/m_axi_aclk] [get_bd_pins axi_cdma_0/s_axi_lite_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins blk_mem_gen_0/clkb] [get_bd_pins blk_mem_gen_1/clkb] [get_bd_pins convolution_0/clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_50M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_1/s_axi_aresetn] [get_bd_pins axi_cdma_0/s_axi_lite_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins convolution_0/rst] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]
